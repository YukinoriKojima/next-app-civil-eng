      ...
      <div className={styles.container}>
        ...
        <div className={styles.main}>
          ...
          <div className={styles.contents}>
            <button className={styles.btn} onClick={NextButtonHandler1}>
              ゲーム1からゲーム2に
              <br />
              進めるようにする
            </button>
            ...
            <p className={styles.btmg5}>　</p>
            <button className={styles.btn} onClick={NextButtonHandler2}>
              ゲーム2からゲーム3に
              <br />
              進めるようにする
            </button>
            <p className={styles.btmg5}>　</p>
            <button className={styles.btn} onClick={NextButtonHandler3}>
              ゲーム3からゲーム4に
              <br />
              進めるようにする
            </button>
            <p className={styles.btmg5}>　</p>
            <button className={styles.btn} onClick={NextButtonHandler4}>
              ゲーム4から結果発表に
              <br />
              進めるようにする
            </button>
