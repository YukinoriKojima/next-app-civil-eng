...
export default function Start() {
    ...
    const [PointNames, setPointNames] = useState([
        { name: "", point: 0 }, { name: "", point: 0 }, { name: "", point: 0 }, { name: "", point: 0 }
    ])
                ...
                <div className={styles.pagetitlebox}>
                    ...
                    <div className={styles.tablebox}>
                        <table className={styles.table}>
                            <thead>
                                <tr>
                                    <th>順位</th><th>社名</th><th>得点</th>
                                </tr>
                            </thead>

                            {isDisplay == 1 ?
                                <tbody>
                                    <tr className={styles.first}><td width="300px"  height="100">優勝</td><td width="300px"  height="100">{PointNames[0].name}</td><td width="300px"  height="100">{PointNames[0].point}</td></tr>
                                    <tr className={styles.second}><td width="300px"  height="100">2nd</td><td width="300px"  height="100">{PointNames[1].name}</td><td width="300px"  height="100">{PointNames[1].point}</td></tr>
                                    <tr className={styles.third}><td width="300px"  height="100">3rd</td><td width="300px"  height="100">{PointNames[2].name}</td><td width="300px"  height="100">{PointNames[2].point}</td></tr>
                                    <tr><td width="300px"  height="100">4th</td><td width="300px"  height="100">{PointNames[3].name}</td><td width="300px"  height="100">{PointNames[3].point}</td></tr>
                                </tbody>
                                :
                                <tbody>

                                    <tr className={styles.first}>   <td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td></tr>
                                    <tr className={styles.second}>   <td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td></tr>
                                    <tr className={styles.third}>   <td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td></tr>
                                    <tr>   <td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td><td width="300px"  height="100">　　　</td></tr>
                                </tbody>}
                        </table></div><br />
                    <button className={styles.btn}
                        onClick={displayRanking}>
                        結果を表示する
                    </button>
                </main>
