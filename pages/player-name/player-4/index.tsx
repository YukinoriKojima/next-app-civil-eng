        ...
        <>
            <div className={styles.container}>
                <div className={styles.main}>
                    <div className={styles.pagetitlebox}><h1>Player 4<br/>名前変更</h1></div>
                    <p className={styles.normaltextleft}>
                        <strong>地域について</strong><br /><br />
                        ...
                        このように、工事現場に近い企業が有利になるということが現実には考えられます。<br /><br />
                        今回は、日本を「北日本」「中日本」「西日本」の3地域に分割し、皆さんに自分の会社の所在地を選択していただきます。<br />
                        入札11~15では，他の入札のように一番低い価格を入札した人が落札権を手にするのではなく，
                        以下のような落札ポイントが高い参加者が落札できます。<br /><br />
                        <strong>落札ポイント＝ [ 10 × (3人の中での最高入札額) /  (あなたの入札額)]  + (地域ポイント)</strong><br /><br />
                        入札額が分母にあるので、入札額が低いほど落札しやすいのは他と同じです。しかし、「地域ポイント」が存在しています。
                        地域ポイントは以下のようにして決まります。<br /><br /></p>
                        <center><Image src={LocalImage}  alt="地域ポイント"/></center><br />
                        <p className={styles.normaltextleft}>
                        例えば、工事の条件が<br />
                        最低価格：5億円、最高価格：10億円、入札経費：1億円、工事費：3億円、場所：西日本<br />
                        で、各社の入札・地域が<br /></p>
                    <p className={styles.normaltextcenter}>
                        A社：3億円・北日本<br />
                        B社：8億円・西日本<br />
                        C社：6億円・中日本<br />
                    </p><p className={styles.normaltextleft}>
                        の場合、落札ポイントは</p><p className={styles.normaltextcenter}>
                        <br />
                        A社：8億/3億＋1=3.33<br />
                        B社：8億/8億＋3=4<br />
                        C社：8億/6億＋2=3.33<br /></p>
                    <p className={styles.normaltextleft}><br/>
                        で、B社は5~10億円に収まっているため、B社が8億円で落札できます。<br/>
                            ...
                            <tr>
                                <td className={styles.cell}>
                                    ...
                                    <form onSubmit={handleSubmit} className={styles.form}>
                                        ...
                                        <button disabled={status === 'empty' || status === 'submitting'} className={styles.btn}>名前変更</button>
                                    </form></td>
                                <td className={styles.cell}>
                                    <h1>あなたの地域は{region}です</h1>
                                    <Select options={Regions} onChange={selectChenge} className={styles.pulldown} />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <br/>
                    <div>
                        {(region != '' && name != '') ? <Link href='../../turn-1/submit/player-4'><button className={styles.btn}>次へ進む</button></Link>
