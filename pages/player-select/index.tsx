        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <p className={styles.normaltextleft}>
                    入札に入る前に、簡単に入札に関連する用語について説明します<br/><br/>
                    <strong>入札経費</strong><br/>
                    入札を行うために必要な経費です。
                    入札経費は事業の落札可否に関わらず、入札すると発生します。<br/><br/>
                    <strong>工事原価</strong><br/>
                    実際に建設工事を行うために要する費用です。工事原価は建設事業ごとに設定されています。
                    建設事業を落札した建設会社は、この工事原価を支払い、建設工事を行います。
                    <br/>つまり、建設事業の落札に成功すると、落札金額から入札経費および工事原価を差し引いた金額を、基本利益として得ることになります。</p>
                    <p className={styles.normaltextcenter}>
                    <br/>
                    基本利益 ＝ 落札金額 − 入札経費 − 工事原価<br/><br/></p>
                    <p className={styles.normaltextleft}>
                    <strong>最低価格・最高価格</strong><br/>
                    ...
                    だいたいの割合を予測し、最高価格と最低価格の間に収まるように入札価格を決めなければいけません。<br/>
                ...
                <div className={styles.contents}>
                    <div className={styles.item}>
                        <Link href={"../player-name/player-1"}>
                            <button className={styles.btn} type="button">Player 1</button>
                        </Link>
                    </div>
                    <div className={styles.item}>
                        <Link href={"../player-name/player-2"}>
                            <button className={styles.btn} type="button">Player 2</button>
                        </Link>
                    </div>
                    <div className={styles.item}>
                        <Link href={"../player-name/player-3"}>
                            <button className={styles.btn} type="button">Player 3</button>
                        </Link>
                    </div>
                    <div className={styles.item}>
                        <Link href={"../player-name/player-4"}>
                            <button className={styles.btn} type="button">Player 4</button>
                        </Link>
                    </div>
                </div>
            </main>
