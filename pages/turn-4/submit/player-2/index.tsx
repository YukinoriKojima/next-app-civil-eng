        ...
        <>
            ...
            <p className={styles.btmg5}>　</p>
                <div className={styles.main}>
                    <div className={styles.pagetitlebox}><h1>Player 2<br />工事16~20入札</h1></div>
                    ...
                    <form>
                        ...
                        <div className={styles.biddings}>
                            ...
                            <div className={styles.biddings}>
                                事業18：海底基地「Plateau」建設工事<br />
                                工事費：700億円<br />
                                入札経費：70億円<br />
                                あなたの入札額：{answer3}<br />
                                <textarea disabled={isAnswer3 == 0}
                            ...
                            <div className={styles.biddings}>
                                事業20：ザハ・ハディド案新国立競技場建設工事<br />
                                工事費：1500億円<br />
                                入札経費：150億円<br />
                                あなたの入札額：{answer5}億円<br />
                                <textarea disabled={isAnswer5 == 0}
                    ...
                    <div>
                        {((isAnswer1 == 0 || answer1 != "") &&
                            ...
                            <button onClick={ConfirmButtonHandler}
                                className={styles.btn}>入札を確定する</button>
